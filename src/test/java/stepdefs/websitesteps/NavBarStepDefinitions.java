...
public class NavBarStepDefinitions {
    ...
    public void selectEditProfile(String value) {
    ...
    public void editFirstAddress(String firstaddres) {
    ...
    public void editSecondAddress(String secondaddress) {
    ...
    @And("^Add AppSuite : \"([^\"]*)\"$")
    public void addAppSuite(String app_suit) {
    ...
    @And("^Add CityOnEdit : \"([^\"]*)\"$")
    public void addCityOnEdit(String city) {
    ...
    public void clickToSelectState(String value) {
...
//        Assert.assertEquals(driver.getCurrentUrl(),value="http://nj-staging.vianovahealth.com/users/33/edit");
    ...
    @And("^select A state : \"([^\"]*)\"$")
    public void selectAState(String value) {
        element = driver.findElement(By.cssSelector("option[value='" + value + "']"));
        element.click();
    }

    @Then("^FillSecondPartoF Edit Profile$")
    public void fillsecondpartofEditProfile() {
    }

    @And("^Set Zip Number : \"([^\"]*)\"$")
    public void setZipNumber(String zip_code) {
    ...
    public void selectACategory(String value) {
        element = driver.findElement(By.cssSelector("option[value='" + value + "']"));
        element.click();
    ...
    public void theUserClickCancelButton(String value) {
        element = driver.findElement(By.cssSelector("a[href='" + value + "']"));
        element.click();
    ...
    public void clickChangepassword(String value) {
        element = driver.findElement(By.cssSelector("a[href='" + value + "']"));
        element.click();
    ...
    public void userWaitForNextStep(){
    }
    ...
    public void setNewPasswordConfirm(String newPassword_confirm) {
    ...
    public void clickOnViewPatient(String value) {
        element = driver.findElement(By.cssSelector("a[href='" + value + "']"));
        element.click();
        Assert.assertEquals(driver.getCurrentUrl(), "https://nj-staging.vianovahealth.com/patients?status=active");
    }
    ...
    public void userClickAndSelectFirstResult() {
    ...
    @And("^User click and select first result :\"([^\"]*)\"$")
    public void userClickAndSelectFirstResult(String click) {
...
//        element =driver.findElement(By.className("dismiss-new"));
    ...
    public void afterClickANewWindowIsAppeardAndSelctAVital(String value) {
    ...
    public void afterClickANewWindowIsAppeardAndSelctADate(String data) {
    ...
    public void afterClickANewWindowIsAppeardAndSelctAValue(String value) {
    ...
    public void afterClickANewWindowIsAppeardAndSelctATimeOfDay()  {
...
//        element.click();
    ...
    public void afterClickANewWindowIsAppeardAndSelctATimeOfMeal()  {
    ...
    public void clickADDButton(String classname) {
        element = driver.findElement(By.className("btn-blue"));
        element.click();
        Assert.assertEquals(driver.getCurrentUrl(), "https://nj-staging.vianovahealth.com/patients/342/controls");
    ...
    public void userClickSummaries(String summaries) {
    ...
    public void userClickSummariesAndSubmitPreviewMedication(String previewMedication) {
    ...
    public void userClickOnComunications(String comunications) {
    ...
    public void userClickOnComunicationsAndSentSmsNow(String smsfield) {
    ...
    public void userClickOnComunicationsAndFillSentSmsField(String smsfield) {
    ...
    public void userClickOnComunicationsAndClickSentButtonForSent(String sentbtn) {
    ...
    public void userClickOnComunicationsAndClickCareNoteMinutes(String mincare) {
    ...
    public void userClickOnCareplan(String careplan) {
...
//    }
    ...
    public void userClickOnCareplanAndClickAddMediction(String addmedication) {
...
//        new WebDriverWait(driver,10).until(ExpectedConditions.elementToBeClickable(By.id(addmedication)));
    ...
    public void userClickOnCareplnNdClickAddMeciactionName(String medicament_name) {
    ...
    public void userClickOnCareplanAndClickAddMedictionFrequency(String value) {
    ...
    public void userClickOnCareplanAndClickAddMedicationDosage(String dose) {
    ...
    public void userClickOnCareplanAndClickAddMedicationPRN(String arg0) {
    ...
    public void userClickOnCareplanAndClickAddMedictionTimeOfDay() {
    ...
    public void userClickOnCareplanAndClickAddMedictionDescription(String description) {
